...
class RealTimeFaceDetector:
    def __init__(self):
        # Define the model path to the user's custom trained model
        self.model_path = r'D:\YOLO\ultralytics\runs\detect\wider_full_training_20250630_234750\weights\best.pt'
